...
class TelegrafInlineMenu {
    ...
    replyMenuMiddleware() {
        const result = {
            middleware: () => async (ctx) => result.setSpecific(ctx, ''),
    ...
    pagination(action, additionalArgs) {
        ...
        this.buttons.addCreator(async (ctx) => {
            ...
            return select_1.generateSelectButtons(action, optionsArray, {
    ...
    question(text, action, additionalArgs) {
        ...
        const hitQuestionButton = async (ctx) => {
            ...
            const extra = telegraf_1.Extra.markdown().markup(telegraf_1.Markup.forceReply());
            await Promise.all([
    ...
    middleware(actionCode, options) {
        ...
        const setMenuFunc = async (ctx, reason, actionOverride) => {
            ...
            options.log('set menu', (actionOverride !== null && actionOverride !== void 0 ? actionOverride : actionCode).get(), reason, this);
            return this.setMenuNow(ctx, actionOverride !== null && actionOverride !== void 0 ? actionOverride : actionCode, options);
        };
        const functions = [];

...
function selectButtonCreator(action, optionsFunc, additionalArgs) {
    ...
    return async (ctx) => {
        ...
        const textOnlyFunc = textFunc !== null && textFunc !== void 0 ? textFunc : fallbackKeyTextFunc;
        const keyTextFunc = async (...args) => prefix_1.prefixEmoji(textOnlyFunc, prefixFunc !== null && prefixFunc !== void 0 ? prefixFunc : isSetFunc, Object.assign({ hideFalseEmoji: !multiselect }, additionalArgs), ...args);

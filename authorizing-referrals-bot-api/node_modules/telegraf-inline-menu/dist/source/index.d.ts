...
import { Extra, Context as TelegrafContext } from 'telegraf';
...
export default class TelegrafInlineMenu {
    ...
    protected generate(ctx: TelegrafContext, actionCode: ActionCode, options: InternalMenuOptions): Promise<{
        text: string;
        extra: Extra;
    }>;
    protected setMenuNow(ctx: TelegrafContext, actionCode: ActionCode, options: InternalMenuOptions): Promise<void>;
